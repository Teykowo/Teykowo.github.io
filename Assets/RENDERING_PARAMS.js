function RENDERING_PARAMS(){
    ...
    const vv_bufferDataType = window.linkedContext.FLOAT;
    ...
    const vc_bufferDataType = window.linkedContext.FLOAT;
    ...
    const draw_type = window.linkedContext.UNSIGNED_SHORT;
