...
function main(){
    ...
    canvasMainBackground.setup([1, 1, 1, 0, 0], 'Assets/Buffer_DATA/gear2simple.obj', undefined, undefined, [1, 1, 1, 1]);
    canvasMainBackground.transVList.push([0.0, 0.0, -10.0]);
    canvasMainBackground.rotVList.push([0.2, 0.4, 0.3]);
    canvasMainBackground.objectTimeAlive.push(0.0);
    ...
    function renderingLoop(timeSinceStart) {
        ...
        canvasMainBackground.objectWiseRendering(0, deltaTime)
        canvasesList.slice(1).forEach(canvas_i => {
